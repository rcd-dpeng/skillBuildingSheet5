...
module top ;
    ...
    CyControlReg_v1_80 Control_Reg_SS (
        .control_1(Net_933),
        .control_2(Net_934),
        .control_3(Net_935),
        .control_0(Net_936),
    ...
    defparam Control_Reg_SS.Bit0Mode = 0;
    defparam Control_Reg_SS.Bit1Mode = 0;
    defparam Control_Reg_SS.Bit2Mode = 0;
    defparam Control_Reg_SS.Bit3Mode = 0;
    defparam Control_Reg_SS.Bit4Mode = 0;
    defparam Control_Reg_SS.Bit5Mode = 0;
    defparam Control_Reg_SS.Bit6Mode = 0;
    defparam Control_Reg_SS.Bit7Mode = 0;
    defparam Control_Reg_SS.BitValue = 0;
    defparam Control_Reg_SS.BusDisplay = 1;
    defparam Control_Reg_SS.ExtrReset = 0;
    defparam Control_Reg_SS.NumOutputs = 2;
	...
	assign tmpOE__Rpi_miso_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_2193} : {Net_2193};
    ...
    SPI_Master_v2_50_4 SPIM_SigGen (
        .mosi(Net_2161),
        .sclk(Net_2162),
        .ss(Net_2163),
        .miso(Net_2160),
    ...
    defparam SPIM_SigGen.BidirectMode = 0;
    defparam SPIM_SigGen.HighSpeedMode = 0;
    defparam SPIM_SigGen.NumberOfDataBits = 16;
    defparam SPIM_SigGen.ShiftDir = 0;
    ...
    CyControlReg_v1_80 Control_Reg_SS_SigGen (
        .control_1(Net_2170),
        .control_2(Net_2171),
        .control_3(Net_2172),
        .control_0(Net_2173),
    ...
    defparam Control_Reg_SS_SigGen.Bit0Mode = 0;
    defparam Control_Reg_SS_SigGen.Bit1Mode = 0;
    defparam Control_Reg_SS_SigGen.Bit2Mode = 0;
    defparam Control_Reg_SS_SigGen.Bit3Mode = 0;
    defparam Control_Reg_SS_SigGen.Bit4Mode = 0;
    defparam Control_Reg_SS_SigGen.Bit5Mode = 0;
    defparam Control_Reg_SS_SigGen.Bit6Mode = 0;
    defparam Control_Reg_SS_SigGen.Bit7Mode = 0;
    defparam Control_Reg_SS_SigGen.BitValue = 0;
    defparam Control_Reg_SS_SigGen.BusDisplay = 1;
    defparam Control_Reg_SS_SigGen.ExtrReset = 0;
    defparam Control_Reg_SS_SigGen.NumOutputs = 2;
