// ======================================================================
// Number1.v generated from TopDesign.cysch
// 01/02/2018 at 16:10
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=20000, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=60000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_1, CY_INSTANCE_SHORT_NAME=PWM_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=PWM_1, )
module PWM_v3_30_9 (
    reset,
    clock,
    tc,
...
module top ;
    ...
    begin : demux_1
        ...
        always @(Net_91 or Net_92)
        begin
            case (Net_92[1:0])
                2'b00:
                begin
                    tmp__demux_1_0_reg = Net_91;
                ...
                begin
                    ...
                    tmp__demux_1_1_reg = 1'b0;
                    tmp__demux_1_2_reg = 1'b0;
                    tmp__demux_1_3_reg = Net_91;
                end
            endcase
        end
        assign Net_87 = tmp__demux_1_0_reg;
        assign Net_88 = tmp__demux_1_1_reg;
        assign Net_89 = tmp__demux_1_2_reg;
        assign Net_90 = tmp__demux_1_3_reg;
    end
    // -- De Mux end --


    assign Net_105 = ~Net_89;


    assign Net_106 = ~Net_90;


    assign Net_103 = ~Net_87;


    assign Net_104 = ~Net_88;


    assign Net_91 = ~Net_15;

	wire [0:0] tmpOE__cs_a_net;
	wire [0:0] tmpFB_0__cs_a_net;
	wire [0:0] tmpIO_0__cs_a_net;
	wire [0:0] tmpINTERRUPT_0__cs_a_net;
	electrical [0:0] tmpSIOVREF__cs_a_net;
	...
	cy_psoc3_pins_v1_10
		...
		cs_a
		 (.oe(tmpOE__cs_a_net),
		  .y({Net_103}),
		  .fb({tmpFB_0__cs_a_net[0:0]}),
		  .io({tmpIO_0__cs_a_net[0:0]}),
		  .siovref(tmpSIOVREF__cs_a_net),
		  .interrupt({tmpINTERRUPT_0__cs_a_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cs_a_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cs_b_net;
	wire [0:0] tmpFB_0__cs_b_net;
	wire [0:0] tmpIO_0__cs_b_net;
	wire [0:0] tmpINTERRUPT_0__cs_b_net;
	electrical [0:0] tmpSIOVREF__cs_b_net;
	...
	cy_psoc3_pins_v1_10
		...
		cs_b
		 (.oe(tmpOE__cs_b_net),
		  .y({Net_104}),
		  .fb({tmpFB_0__cs_b_net[0:0]}),
		  .io({tmpIO_0__cs_b_net[0:0]}),
		  .siovref(tmpSIOVREF__cs_b_net),
		  .interrupt({tmpINTERRUPT_0__cs_b_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cs_b_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cs_c_net;
	wire [0:0] tmpFB_0__cs_c_net;
	wire [0:0] tmpIO_0__cs_c_net;
	wire [0:0] tmpINTERRUPT_0__cs_c_net;
	electrical [0:0] tmpSIOVREF__cs_c_net;
	...
	cy_psoc3_pins_v1_10
		...
		cs_c
		 (.oe(tmpOE__cs_c_net),
		  .y({Net_105}),
		  .fb({tmpFB_0__cs_c_net[0:0]}),
		  .io({tmpIO_0__cs_c_net[0:0]}),
		  .siovref(tmpSIOVREF__cs_c_net),
		  .interrupt({tmpINTERRUPT_0__cs_c_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cs_c_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cs_d_net;
	wire [0:0] tmpFB_0__cs_d_net;
	wire [0:0] tmpIO_0__cs_d_net;
	wire [0:0] tmpINTERRUPT_0__cs_d_net;
	electrical [0:0] tmpSIOVREF__cs_d_net;
	...
	cy_psoc3_pins_v1_10
		...
		cs_d
		 (.oe(tmpOE__cs_d_net),
		  .y({Net_106}),
		  .fb({tmpFB_0__cs_d_net[0:0]}),
		  .io({tmpIO_0__cs_d_net[0:0]}),
		  .siovref(tmpSIOVREF__cs_d_net),
		  .interrupt({tmpINTERRUPT_0__cs_d_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cs_d_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 SPIM_Mux (
        .control_1(Net_107),
        .control_2(Net_108),
        .control_3(Net_109),
        .control_0(Net_110),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_92[1:0]));
    defparam SPIM_Mux.Bit0Mode = 0;
    defparam SPIM_Mux.Bit1Mode = 0;
    defparam SPIM_Mux.Bit2Mode = 0;
    defparam SPIM_Mux.Bit3Mode = 0;
    defparam SPIM_Mux.Bit4Mode = 0;
    defparam SPIM_Mux.Bit5Mode = 0;
    defparam SPIM_Mux.Bit6Mode = 0;
    defparam SPIM_Mux.Bit7Mode = 0;
    defparam SPIM_Mux.BitValue = 0;
    defparam SPIM_Mux.BusDisplay = 1;
    defparam SPIM_Mux.ExtrReset = 0;
    defparam SPIM_Mux.NumOutputs = 2;

    SPI_Slave_v2_70_1 RPi_SPIS (
        .mosi(Net_118),
        .sclk(Net_119),
        .ss(Net_120),
        .miso(Net_138),
        ...
        .miso_oe(Net_126),
        .reset(1'b0));
    defparam RPi_SPIS.NumberOfDataBits = 8;
    defparam RPi_SPIS.ShiftDir = 0;

	wire [0:0] tmpOE__Rpi_mosi_net;
	wire [0:0] tmpIO_0__Rpi_mosi_net;
	wire [0:0] tmpINTERRUPT_0__Rpi_mosi_net;
	electrical [0:0] tmpSIOVREF__Rpi_mosi_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("81ec8f8e-2114-4154-8b5b-7a558117890b"),
		  ...
		  .input_buffer_sel(2'b00))
		Rpi_mosi
		 (.oe(tmpOE__Rpi_mosi_net),
		  .y({1'b0}),
		  .fb({Net_118}),
		  .io({tmpIO_0__Rpi_mosi_net[0:0]}),
		  .siovref(tmpSIOVREF__Rpi_mosi_net),
		  .interrupt({tmpINTERRUPT_0__Rpi_mosi_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rpi_mosi_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Rpi_miso_net;
	wire [0:0] tmpFB_0__Rpi_miso_net;
	wire [0:0] tmpIO_0__Rpi_miso_net;
	wire [0:0] tmpINTERRUPT_0__Rpi_miso_net;
	electrical [0:0] tmpSIOVREF__Rpi_miso_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Rpi_miso
		 (.oe(tmpOE__Rpi_miso_net),
		  .y({Net_138}),
		  .fb({tmpFB_0__Rpi_miso_net[0:0]}),
		  .io({tmpIO_0__Rpi_miso_net[0:0]}),
		  .siovref(tmpSIOVREF__Rpi_miso_net),
		  .interrupt({tmpINTERRUPT_0__Rpi_miso_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rpi_miso_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_126} : {Net_126};

	wire [0:0] tmpOE__Rpi_sclk_net;
	wire [0:0] tmpIO_0__Rpi_sclk_net;
	wire [0:0] tmpINTERRUPT_0__Rpi_sclk_net;
	electrical [0:0] tmpSIOVREF__Rpi_sclk_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8aed0129-5aa1-470b-bb43-12ee4cd94324"),
		  ...
		  .input_buffer_sel(2'b00))
		Rpi_sclk
		 (.oe(tmpOE__Rpi_sclk_net),
		  .y({1'b0}),
		  .fb({Net_119}),
		  .io({tmpIO_0__Rpi_sclk_net[0:0]}),
		  .siovref(tmpSIOVREF__Rpi_sclk_net),
		  .interrupt({tmpINTERRUPT_0__Rpi_sclk_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rpi_sclk_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Rpi_ss_net;
	wire [0:0] tmpIO_0__Rpi_ss_net;
	wire [0:0] tmpINTERRUPT_0__Rpi_ss_net;
	electrical [0:0] tmpSIOVREF__Rpi_ss_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b480d996-95f9-45dc-9029-608be6db4d4b"),
		  ...
		  .input_buffer_sel(2'b00))
		Rpi_ss
		 (.oe(tmpOE__Rpi_ss_net),
		  .y({1'b0}),
		  .fb({Net_120}),
		  .io({tmpIO_0__Rpi_ss_net[0:0]}),
		  .siovref(tmpSIOVREF__Rpi_ss_net),
		  .interrupt({tmpINTERRUPT_0__Rpi_ss_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rpi_ss_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin : demux_2
        ...
        always @(Net_232 or Net_233)
        begin
            case (Net_233[1:0])
                2'b00:
                begin
                    tmp__demux_2_0_reg = Net_232;
                ...
                begin
                    ...
                    tmp__demux_2_1_reg = 1'b0;
                    tmp__demux_2_2_reg = 1'b0;
                    tmp__demux_2_3_reg = Net_232;
                end
            endcase
        end
        assign Net_228 = tmp__demux_2_0_reg;
        assign Net_247 = tmp__demux_2_1_reg;
        assign Net_249 = tmp__demux_2_2_reg;
        assign Net_251 = tmp__demux_2_3_reg;
    end
    // -- De Mux end --

    CyControlReg_v1_80 SPIM_1_Mux (
        .control_1(Net_234),
        .control_2(Net_235),
        .control_3(Net_236),
        .control_0(Net_237),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_233[1:0]));
    defparam SPIM_1_Mux.Bit0Mode = 0;
    defparam SPIM_1_Mux.Bit1Mode = 0;
    defparam SPIM_1_Mux.Bit2Mode = 0;
    defparam SPIM_1_Mux.Bit3Mode = 0;
    defparam SPIM_1_Mux.Bit4Mode = 0;
    defparam SPIM_1_Mux.Bit5Mode = 0;
    defparam SPIM_1_Mux.Bit6Mode = 0;
    defparam SPIM_1_Mux.Bit7Mode = 0;
    defparam SPIM_1_Mux.BitValue = 0;
    defparam SPIM_1_Mux.BusDisplay = 1;
    defparam SPIM_1_Mux.ExtrReset = 0;
    defparam SPIM_1_Mux.NumOutputs = 2;


    assign Net_246 = ~Net_228;


    assign Net_248 = ~Net_247;


    assign Net_250 = ~Net_249;


    assign Net_252 = ~Net_251;

	wire [0:0] tmpOE__cs_1d_net;
	wire [0:0] tmpFB_0__cs_1d_net;
	wire [0:0] tmpIO_0__cs_1d_net;
	wire [0:0] tmpINTERRUPT_0__cs_1d_net;
	electrical [0:0] tmpSIOVREF__cs_1d_net;
	...
	cy_psoc3_pins_v1_10
		...
		cs_1d
		 (.oe(tmpOE__cs_1d_net),
		  .y({Net_252}),
		  .fb({tmpFB_0__cs_1d_net[0:0]}),
		  .io({tmpIO_0__cs_1d_net[0:0]}),
		  .siovref(tmpSIOVREF__cs_1d_net),
		  .interrupt({tmpINTERRUPT_0__cs_1d_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cs_1d_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cs_1c_net;
	wire [0:0] tmpFB_0__cs_1c_net;
	wire [0:0] tmpIO_0__cs_1c_net;
	wire [0:0] tmpINTERRUPT_0__cs_1c_net;
	electrical [0:0] tmpSIOVREF__cs_1c_net;
	...
	cy_psoc3_pins_v1_10
		...
		cs_1c
		 (.oe(tmpOE__cs_1c_net),
		  .y({Net_250}),
		  .fb({tmpFB_0__cs_1c_net[0:0]}),
		  .io({tmpIO_0__cs_1c_net[0:0]}),
		  .siovref(tmpSIOVREF__cs_1c_net),
		  .interrupt({tmpINTERRUPT_0__cs_1c_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cs_1c_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cs_1b_net;
	wire [0:0] tmpFB_0__cs_1b_net;
	wire [0:0] tmpIO_0__cs_1b_net;
	wire [0:0] tmpINTERRUPT_0__cs_1b_net;
	electrical [0:0] tmpSIOVREF__cs_1b_net;
	...
	cy_psoc3_pins_v1_10
		...
		cs_1b
		 (.oe(tmpOE__cs_1b_net),
		  .y({Net_248}),
		  .fb({tmpFB_0__cs_1b_net[0:0]}),
		  .io({tmpIO_0__cs_1b_net[0:0]}),
		  .siovref(tmpSIOVREF__cs_1b_net),
		  .interrupt({tmpINTERRUPT_0__cs_1b_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cs_1b_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cs_1a_net;
	wire [0:0] tmpFB_0__cs_1a_net;
	wire [0:0] tmpIO_0__cs_1a_net;
	wire [0:0] tmpINTERRUPT_0__cs_1a_net;
	electrical [0:0] tmpSIOVREF__cs_1a_net;
	...
	cy_psoc3_pins_v1_10
		...
		cs_1a
		 (.oe(tmpOE__cs_1a_net),
		  .y({Net_246}),
		  .fb({tmpFB_0__cs_1a_net[0:0]}),
		  .io({tmpIO_0__cs_1a_net[0:0]}),
		  .siovref(tmpSIOVREF__cs_1a_net),
		  .interrupt({tmpINTERRUPT_0__cs_1a_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cs_1a_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyControlReg_v1_80 EnableBattery (
        .control_1(Net_260),
        .control_2(Net_261),
        .control_3(Net_262),
        .control_0(Net_263),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam EnableBattery.Bit0Mode = 0;
    defparam EnableBattery.Bit1Mode = 0;
    defparam EnableBattery.Bit2Mode = 0;
    defparam EnableBattery.Bit3Mode = 0;
    defparam EnableBattery.Bit4Mode = 0;
    defparam EnableBattery.Bit5Mode = 0;
    defparam EnableBattery.Bit6Mode = 0;
    defparam EnableBattery.Bit7Mode = 0;
    defparam EnableBattery.BitValue = 0;
    defparam EnableBattery.BusDisplay = 0;
    defparam EnableBattery.ExtrReset = 0;
    defparam EnableBattery.NumOutputs = 2;

    CyControlReg_v1_80 Slush_Interrupts (
        .control_1(Net_270),
        .control_2(Net_271),
        .control_3(Net_272),
        .control_0(Net_273),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Slush_Interrupts.Bit0Mode = 0;
    defparam Slush_Interrupts.Bit1Mode = 0;
    defparam Slush_Interrupts.Bit2Mode = 0;
    defparam Slush_Interrupts.Bit3Mode = 0;
    defparam Slush_Interrupts.Bit4Mode = 0;
    defparam Slush_Interrupts.Bit5Mode = 0;
    defparam Slush_Interrupts.Bit6Mode = 0;
    defparam Slush_Interrupts.Bit7Mode = 0;
    defparam Slush_Interrupts.BitValue = 0;
    defparam Slush_Interrupts.BusDisplay = 0;
    defparam Slush_Interrupts.ExtrReset = 0;
    defparam Slush_Interrupts.NumOutputs = 2;

    CyStatusReg_v1_90 Slush_I2C_interrupts (
        .status_0(Net_280),
        .status_1(Net_281),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .intr(Net_289),
        .status_bus(8'b0));
    defparam Slush_I2C_interrupts.Bit0Mode = 0;
    defparam Slush_I2C_interrupts.Bit1Mode = 0;
    defparam Slush_I2C_interrupts.Bit2Mode = 0;
    defparam Slush_I2C_interrupts.Bit3Mode = 0;
    defparam Slush_I2C_interrupts.Bit4Mode = 0;
    defparam Slush_I2C_interrupts.Bit5Mode = 0;
    defparam Slush_I2C_interrupts.Bit6Mode = 0;
    defparam Slush_I2C_interrupts.Bit7Mode = 0;
    defparam Slush_I2C_interrupts.BusDisplay = 0;
    defparam Slush_I2C_interrupts.Interrupt = 1;
    defparam Slush_I2C_interrupts.MaskValue = 0;
    defparam Slush_I2C_interrupts.NumInputs = 2;

	wire [0:0] tmpOE__slush_inta_net;
	wire [0:0] tmpIO_0__slush_inta_net;
	wire [0:0] tmpINTERRUPT_0__slush_inta_net;
	electrical [0:0] tmpSIOVREF__slush_inta_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("30a5e044-0e87-4b43-b4f4-1b399d7109e5"),
		  ...
		  .input_buffer_sel(2'b00))
		slush_inta
		 (.oe(tmpOE__slush_inta_net),
		  .y({1'b0}),
		  .fb({Net_280}),
		  .io({tmpIO_0__slush_inta_net[0:0]}),
		  .siovref(tmpSIOVREF__slush_inta_net),
		  .interrupt({tmpINTERRUPT_0__slush_inta_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__slush_inta_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__slush_intb_net;
	wire [0:0] tmpIO_0__slush_intb_net;
	wire [0:0] tmpINTERRUPT_0__slush_intb_net;
	electrical [0:0] tmpSIOVREF__slush_intb_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5f08f199-8b46-42f4-a082-695f9fd22e31"),
		  ...
		  .input_buffer_sel(2'b00))
		slush_intb
		 (.oe(tmpOE__slush_intb_net),
		  .y({1'b0}),
		  .fb({Net_281}),
		  .io({tmpIO_0__slush_intb_net[0:0]}),
		  .siovref(tmpSIOVREF__slush_intb_net),
		  .interrupt({tmpINTERRUPT_0__slush_intb_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__slush_intb_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__rpi_inta_net;
	wire [0:0] tmpFB_0__rpi_inta_net;
	wire [0:0] tmpIO_0__rpi_inta_net;
	wire [0:0] tmpINTERRUPT_0__rpi_inta_net;
	electrical [0:0] tmpSIOVREF__rpi_inta_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("53727e54-82e3-440e-af7b-ab92dad69d76"),
		  ...
		  .input_buffer_sel(2'b00))
		rpi_inta
		 (.oe(tmpOE__rpi_inta_net),
		  .y({Net_273}),
		  .fb({tmpFB_0__rpi_inta_net[0:0]}),
		  .io({tmpIO_0__rpi_inta_net[0:0]}),
		  .siovref(tmpSIOVREF__rpi_inta_net),
		  .interrupt({tmpINTERRUPT_0__rpi_inta_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__rpi_inta_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__rpi_intb_net;
	wire [0:0] tmpFB_0__rpi_intb_net;
	wire [0:0] tmpIO_0__rpi_intb_net;
	wire [0:0] tmpINTERRUPT_0__rpi_intb_net;
	electrical [0:0] tmpSIOVREF__rpi_intb_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c5d2471e-d4b6-4001-a7f8-e6dc81755b5b"),
		  ...
		  .input_buffer_sel(2'b00))
		rpi_intb
		 (.oe(tmpOE__rpi_intb_net),
		  .y({Net_270}),
		  .fb({tmpFB_0__rpi_intb_net[0:0]}),
		  .io({tmpIO_0__rpi_intb_net[0:0]}),
		  .siovref(tmpSIOVREF__rpi_intb_net),
		  .interrupt({tmpINTERRUPT_0__rpi_intb_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__rpi_intb_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__enable_battery_net;
	wire [0:0] tmpFB_0__enable_battery_net;
	wire [0:0] tmpIO_0__enable_battery_net;
	wire [0:0] tmpINTERRUPT_0__enable_battery_net;
	electrical [0:0] tmpSIOVREF__enable_battery_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e5138e73-5e88-4be4-b9b0-aae0d2ef0d96"),
		  ...
		  .input_buffer_sel(2'b00))
		enable_battery
		 (.oe(tmpOE__enable_battery_net),
		  .y({Net_263}),
		  .fb({tmpFB_0__enable_battery_net[0:0]}),
		  .io({tmpIO_0__enable_battery_net[0:0]}),
		  .siovref(tmpSIOVREF__enable_battery_net),
		  .interrupt({tmpINTERRUPT_0__enable_battery_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__enable_battery_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Supply_monitor_net;
	wire [0:0] tmpFB_0__Supply_monitor_net;
	wire [0:0] tmpIO_0__Supply_monitor_net;
	wire [0:0] tmpINTERRUPT_0__Supply_monitor_net;
	electrical [0:0] tmpSIOVREF__Supply_monitor_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Supply_monitor
		 (.oe(tmpOE__Supply_monitor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Supply_monitor_net[0:0]}),
		  .analog({Net_323}),
		  .io({tmpIO_0__Supply_monitor_net[0:0]}),
		  .siovref(tmpSIOVREF__Supply_monitor_net),
		  .interrupt({tmpINTERRUPT_0__Supply_monitor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Supply_monitor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__delta_sig_in_net;
	wire [0:0] tmpFB_0__delta_sig_in_net;
	wire [0:0] tmpIO_0__delta_sig_in_net;
	wire [0:0] tmpINTERRUPT_0__delta_sig_in_net;
	electrical [0:0] tmpSIOVREF__delta_sig_in_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4869dbc8-de9d-486a-884f-e01bb1c4c87d"),
		  ...
		  .input_buffer_sel(2'b00))
		delta_sig_in
		 (.oe(tmpOE__delta_sig_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__delta_sig_in_net[0:0]}),
		  .analog({Net_348}),
		  .io({tmpIO_0__delta_sig_in_net[0:0]}),
		  .siovref(tmpSIOVREF__delta_sig_in_net),
		  .interrupt({tmpINTERRUPT_0__delta_sig_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__delta_sig_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sar_in1_net;
	wire [0:0] tmpFB_0__sar_in1_net;
	wire [0:0] tmpIO_0__sar_in1_net;
	wire [0:0] tmpINTERRUPT_0__sar_in1_net;
	electrical [0:0] tmpSIOVREF__sar_in1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6ea69d95-69aa-47ec-bea8-2dfef04e8370"),
		  ...
		  .input_buffer_sel(2'b00))
		sar_in1
		 (.oe(tmpOE__sar_in1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sar_in1_net[0:0]}),
		  .analog({Net_396}),
		  .io({tmpIO_0__sar_in1_net[0:0]}),
		  .siovref(tmpSIOVREF__sar_in1_net),
		  .interrupt({tmpINTERRUPT_0__sar_in1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sar_in1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__sar_in2_net;
	wire [0:0] tmpFB_0__sar_in2_net;
	wire [0:0] tmpIO_0__sar_in2_net;
	wire [0:0] tmpINTERRUPT_0__sar_in2_net;
	electrical [0:0] tmpSIOVREF__sar_in2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("053d02f3-8eba-4847-be8c-1696bf05f539"),
		  ...
		  .input_buffer_sel(2'b00))
		sar_in2
		 (.oe(tmpOE__sar_in2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sar_in2_net[0:0]}),
		  .analog({Net_397}),
		  .io({tmpIO_0__sar_in2_net[0:0]}),
		  .siovref(tmpSIOVREF__sar_in2_net),
		  .interrupt({tmpINTERRUPT_0__sar_in2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sar_in2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sar_in3_net;
	wire [0:0] tmpFB_0__sar_in3_net;
	wire [0:0] tmpIO_0__sar_in3_net;
	wire [0:0] tmpINTERRUPT_0__sar_in3_net;
	electrical [0:0] tmpSIOVREF__sar_in3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8a56f78c-79fa-434d-bfca-a714e00631d5"),
		  ...
		  .input_buffer_sel(2'b00))
		sar_in3
		 (.oe(tmpOE__sar_in3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sar_in3_net[0:0]}),
		  .analog({Net_398}),
		  .io({tmpIO_0__sar_in3_net[0:0]}),
		  .siovref(tmpSIOVREF__sar_in3_net),
		  .interrupt({tmpINTERRUPT_0__sar_in3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sar_in3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sar_in4_net;
	wire [0:0] tmpFB_0__sar_in4_net;
	wire [0:0] tmpIO_0__sar_in4_net;
	wire [0:0] tmpINTERRUPT_0__sar_in4_net;
	electrical [0:0] tmpSIOVREF__sar_in4_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0fc86f9c-e47f-4f62-8051-97edd1782c5b"),
		  ...
		  .input_buffer_sel(2'b00))
		sar_in4
		 (.oe(tmpOE__sar_in4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sar_in4_net[0:0]}),
		  .analog({Net_399}),
		  .io({tmpIO_0__sar_in4_net[0:0]}),
		  .siovref(tmpSIOVREF__sar_in4_net),
		  .interrupt({tmpINTERRUPT_0__sar_in4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sar_in4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam AMuxSeq_1.muxin_width = 4;
    defparam AMuxSeq_1.init_mux_sel = 4'h0;
	...
	wire [0:0] tmpOE__en_level_shift_net;
	wire [0:0] tmpFB_0__en_level_shift_net;
	wire [0:0] tmpIO_0__en_level_shift_net;
	wire [0:0] tmpINTERRUPT_0__en_level_shift_net;
	electrical [0:0] tmpSIOVREF__en_level_shift_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("45fc01d4-8f92-4aa1-96de-8b25548eb67f"),
		  ...
		  .input_buffer_sel(2'b00))
		en_level_shift
		 (.oe(tmpOE__en_level_shift_net),
		  .y({Net_260}),
		  .fb({tmpFB_0__en_level_shift_net[0:0]}),
		  .io({tmpIO_0__en_level_shift_net[0:0]}),
		  .siovref(tmpSIOVREF__en_level_shift_net),
		  .interrupt({tmpINTERRUPT_0__en_level_shift_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__en_level_shift_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyControlReg_v1_80 PWM_ControlReg (
        .control_1(Net_495),
        .control_2(Net_516),
        .control_3(Net_517),
        .control_0(Net_530),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam PWM_ControlReg.Bit0Mode = 0;
    defparam PWM_ControlReg.Bit1Mode = 0;
    defparam PWM_ControlReg.Bit2Mode = 0;
    defparam PWM_ControlReg.Bit3Mode = 0;
    defparam PWM_ControlReg.Bit4Mode = 0;
    defparam PWM_ControlReg.Bit5Mode = 0;
    defparam PWM_ControlReg.Bit6Mode = 0;
    defparam PWM_ControlReg.Bit7Mode = 0;
    defparam PWM_ControlReg.BitValue = 0;
    defparam PWM_ControlReg.BusDisplay = 0;
    defparam PWM_ControlReg.ExtrReset = 0;
    defparam PWM_ControlReg.NumOutputs = 2;
    ...
    defparam Status_Reg_1.Interrupt = 1;
    defparam Status_Reg_1.MaskValue = 0;
    defparam Status_Reg_1.NumInputs = 2;
	...
	wire [0:0] tmpOE__INT_1_net;
	wire [0:0] tmpIO_0__INT_1_net;
	wire [0:0] tmpINTERRUPT_0__INT_1_net;
	electrical [0:0] tmpSIOVREF__INT_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		INT_1
		 (.oe(tmpOE__INT_1_net),
		  .y({1'b0}),
		  .fb({Net_823}),
		  .io({tmpIO_0__INT_1_net[0:0]}),
		  .siovref(tmpSIOVREF__INT_1_net),
		  .interrupt({tmpINTERRUPT_0__INT_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INT_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__INT_2_net;
	wire [0:0] tmpIO_0__INT_2_net;
	wire [0:0] tmpINTERRUPT_0__INT_2_net;
	electrical [0:0] tmpSIOVREF__INT_2_net;
	...
	cy_psoc3_pins_v1_10
		...
		INT_2
		 (.oe(tmpOE__INT_2_net),
		  .y({1'b0}),
		  .fb({Net_824}),
		  .io({tmpIO_0__INT_2_net[0:0]}),
		  .siovref(tmpSIOVREF__INT_2_net),
		  .interrupt({tmpINTERRUPT_0__INT_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INT_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
