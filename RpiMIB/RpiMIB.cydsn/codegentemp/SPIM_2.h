...
#define SPIM_2_MODE                       (2u)
#define SPIM_2_DATA_WIDTH                 (16u)
...
void  SPIM_2_WriteTxData(uint16 txData)  \
                                                            ;
uint16 SPIM_2_ReadRxData(void) \
                                                            ;
...
void  SPIM_2_PutArray(const uint16 buffer[], uint8 byteCount) \
                                                            ;
...
***************************************/
    ...
    #define SPIM_2_TXDATA_REG (* (reg16 *) \
                                                SPIM_2_BSPIM_sR16_Dp_u0__F0_REG)
    #define SPIM_2_TXDATA_PTR (  (reg16 *) \
                                                SPIM_2_BSPIM_sR16_Dp_u0__F0_REG)
    #define SPIM_2_RXDATA_REG (* (reg16 *) \
                                                SPIM_2_BSPIM_sR16_Dp_u0__F1_REG)
    #define SPIM_2_RXDATA_PTR (  (reg16 *) \
                                                SPIM_2_BSPIM_sR16_Dp_u0__F1_REG)
#else   /* PSOC4 */
    #if(SPIM_2_USE_SECOND_DATAPATH)
        #define SPIM_2_TXDATA_REG (* (reg16 *) \
                                          SPIM_2_BSPIM_sR16_Dp_u0__16BIT_F0_REG)
        #define SPIM_2_TXDATA_PTR (  (reg16 *) \
                                          SPIM_2_BSPIM_sR16_Dp_u0__16BIT_F0_REG)
        #define SPIM_2_RXDATA_REG (* (reg16 *) \
                                          SPIM_2_BSPIM_sR16_Dp_u0__16BIT_F1_REG)
        #define SPIM_2_RXDATA_PTR (  (reg16 *) \
                                          SPIM_2_BSPIM_sR16_Dp_u0__16BIT_F1_REG)
    #else
...
#define SPIM_2_AUX_CONTROL_DP0_REG (* (reg8 *) \
                                        SPIM_2_BSPIM_sR16_Dp_u0__DP_AUX_CTL_REG)
#define SPIM_2_AUX_CONTROL_DP0_PTR (  (reg8 *) \
                                        SPIM_2_BSPIM_sR16_Dp_u0__DP_AUX_CTL_REG)

#if(SPIM_2_USE_SECOND_DATAPATH)
    #define SPIM_2_AUX_CONTROL_DP1_REG  (* (reg8 *) \
                                        SPIM_2_BSPIM_sR16_Dp_u1__DP_AUX_CTL_REG)
