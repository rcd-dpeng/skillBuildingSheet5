...
#include "SPIM_2_PVT.h"
    ...
    volatile uint16 SPIM_2_txBuffer[SPIM_2_TX_BUFFER_SIZE];
    ...
    volatile uint16 SPIM_2_rxBuffer[SPIM_2_RX_BUFFER_SIZE];
...
void SPIM_2_WriteTxData(uint16 txData) 
{
           ...
           (0u != (SPIM_2_swStatusTx & SPIM_2_STS_TX_FIFO_NOT_FULL)))
        {
            ...
            CY_SET_REG16(SPIM_2_TXDATA_PTR, txData);
        }
        else
        {
...
uint16 SPIM_2_ReadRxData(void) 
{
    uint16 rxData;
        ...
        rxData = CY_GET_REG16(SPIM_2_RXDATA_PTR);
...
void SPIM_2_ClearRxBuffer(void) 
{
    ...
    {
        (void) CY_GET_REG16(SPIM_2_RXDATA_PTR);
    }
